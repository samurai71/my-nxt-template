...
export default function TermsAndConditions() {
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 dark:bg-black">
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8 md:p-12 dark:bg-black">
        <h1 className="text-4xl font-bold text-gray-900 mb-4 dark:text-gray-50">
        ...
        <div className="prose prose-gray max-w-none space-y-6">
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3 dark:text-gray-50">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mb-3 dark:text-gray-50">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4 dark:text-gray-50">
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2 dark:text-gray-50">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <p className="text-sm text-gray-600 text-center dark:text-gray-50">
