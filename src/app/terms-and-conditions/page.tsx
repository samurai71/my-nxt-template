...
export default function TermsAndConditions() {
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-12 sm:px-6 lg:px-8 dark:bg-black">
      <div className="mx-auto max-w-4xl rounded-lg bg-white p-8 shadow-lg md:p-12 dark:bg-black">
        <h1 className="mb-4 text-4xl font-bold text-gray-900 dark:text-gray-50">
          Terms and Conditions
        </h1>
        <p className="mb-8 text-sm text-gray-600 dark:text-gray-50">
        ...
        <div className="prose prose-gray max-w-none space-y-6">
          ...
          <section>
            ...
            <ul className="ml-4 list-inside list-disc space-y-2 text-gray-700 dark:text-gray-50">
